...
describe('TransclusionProcessor', () => {
  ...
  it('should populate TransclusionResult', async () => {
    ...
    const result = await transclusionProcessor.resolveIncludes(
      `<html>
    <head>
      <ableron-include src-timeout="500"><!-- failed loading 1st include --></ableron-include>
    <title>Foo</title>
    <ableron-include foo="bar"><!-- failed loading 2nd include --></ableron-include>
    </head>
    <body>
    <ableron-include src-timeout="500"><!-- failed loading 3rd include --></ableron-include>
    </body>
    </html>`
    );
